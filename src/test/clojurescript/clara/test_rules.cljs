(ns clara.test-rules
  (:require-macros [cemerick.cljs.test :refer (is deftest with-test run-tests testing test-var)]
                   [clara.macros :refer [mk-rule defrule mk-query defquery mk-session]])
  (:require [cemerick.cljs.test :as t]
            [clara.rules :refer [mk-rulebase insert retract fire-rules registered-rules 
                                 add-productions query accumulate insert! retract! insert-unconditional!]]
            ...
            [clara.rules.testfacts :refer [->Temperature Temperature ->WindSpeed WindSpeed
                                           ...
                                           ->LousyWeather LousyWither First ->First
                                           Second ->Second Third ->Third Fourth ->Fourth]]
            [clara.sample-ruleset :as sample]
